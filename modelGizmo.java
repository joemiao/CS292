...
public class modelGizmo {
    ...
    private static class BouncingBall {
        ...
        public void move() {
            ...
            for(int i = 0; i<radius ;i++){
            	if(bound[x-radius+i*2+(y-radius)*800]==false){
            		vy=-vy;
            	} if(bound[x-radius+i*2+(y+radius)*800]==false){
            		vy=-vy;
            	}
    ...
    private static class AnimationWindow extends JComponent {
       ...
       //     if(boardMade==false){
        ...
        //this method is to make the boundaries boxes of the gizmos for
        ...
        public Integer xycoord(Integer x, Integer y){
        	return y*800+x;
        }
        /**
    		...
    		//System.out.println(System.getProperty("user.dir"));
    		   ...
    		   while(scanner.hasNext()) {
    		       ...
    		       String s = scanner.next();
    		        //splits a line of string int	o token s and converts them
